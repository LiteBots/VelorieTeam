// VelorieTeam SPA — fixed + hardened (no null crashes)
...
// TODO: reszta widoków (Projects/Employees/Orders/Ideas/Push/ProjectDashboard) –
// możesz wkleić swoje istniejące funkcje 1:1, bo ten szkielet już nie crashuje.
...
async function route() {
  ...
  if (hash.startsWith("#/project/")) {
    // jeśli masz swój viewProjectDashboard() – podmień tu:
    outlet.innerHTML = card("Projekt", "Wklej tu swój viewProjectDashboard()", `<div class="text-white/60 text-sm">#/project/... wykryte</div>`);
    safeLucide();
    return;
  }
